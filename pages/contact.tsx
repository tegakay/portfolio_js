...
const Contact = () => {
  ...
  <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
      ...
      <form action="#" className="space-y-8">
          ...
          <button type="submit" className="py-3 px-5 text-sm bg-blue-500 hover:bg-blue-700 rounded-full text-white  font-medium text-center  sm:w-fit  focus:ring-4 focus:outline-none focus:ring-primary-300 ">Send message</button>
      </form>
  </div>
</section>
   </div>
